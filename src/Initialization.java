...
public class Initialization {
    ...
    ArrayList<Card> playerOneReserves = new ArrayList<Card>(); //storing reserve cards of player one
    ArrayList<Card> playerTwoReserves = new ArrayList<Card>(); //storing reserve cards of player two
    ...
    public void buildLevel1() { //building an arraylist to store level1 cards
        ...
        Card card1 = new Card(1,0, "black", 2, 0, 0, 0, 2);
        level1.add(card1);
        Card card2 = new Card(1,0, "white", 0, 2, 0, 2, 0);
        level1.add(card2);
        Card card3 = new Card(1,0, "green", 0, 0, 2, 2, 0);
        level1.add(card3);
        Card card4 = new Card(1,0, "red", 0, 2, 0, 0, 2);
        level1.add(card4);
        Card card5 = new Card(1,0, "blue", 2, 0, 0, 2, 0);
        level1.add(card5);
        Card card6 = new Card(1,1, "black", 0, 2, 0, 2, 1);
        level1.add(card6);
        Card card7 = new Card(1,1, "blue", 1, 0, 0, 2, 2);
        level1.add(card7);
        Card card8 = new Card(1,1, "red", 2, 0, 1, 0, 2);
        level1.add(card8);
        Card card9 = new Card(1,1, "green", 2, 0, 0, 0, 3);
        level1.add(card9);
        Card card10 = new Card(1,1, "red", 0, 3, 2, 0, 0);
        level1.add(card10);
        Card card11 = new Card(1,1, "green", 0, 2, 0, 2, 2);
        level1.add(card11);
        Card card12 = new Card(1,1, "white", 2, 0, 0, 2, 2);
        level1.add(card12);
        Card card13 = new Card(1,1, "blue", 2, 0, 2, 0, 2);
        level1.add(card13);
        Card card14 = new Card(1,1, "black", 2, 2, 0, 0, 2);
        level1.add(card14);
        Card card15 = new Card(1,1, "white", 2, 0, 2, 2, 0);
        level1.add(card15);
    }

    public void buildLevel2() { //building an arraylist to store level2 cards
        level2 = new ArrayList<Card>();
        Card card1 = new Card(2,2, "black", 0, 2, 0, 2, 2);
        level2.add(card1);
        Card card2 = new Card(2,2, "blue", 2, 0, 0, 2, 2);
        level2.add(card2);
        Card card3 = new Card(2,2, "red", 2, 0, 2, 0, 2);
        level2.add(card3);
        Card card4 = new Card(2,2, "white", 2, 2, 0, 0, 2);
        level2.add(card4);
        Card card5 = new Card(2,2, "green", 2, 0, 2, 2, 0);
        level2.add(card5);
        Card card6 = new Card(2,3, "black", 2, 0, 2, 2, 1);
        level2.add(card6);
        Card card7 = new Card(2,3, "blue", 2, 2, 0, 1, 2);
        level2.add(card7);
        Card card8 = new Card(2,3, "green", 2, 1, 2, 0, 2);
        level2.add(card8);
        Card card9 = new Card(2,3, "red", 2, 0, 1, 2, 2);
        level2.add(card9);
        Card card10 = new Card(2,3, "white", 1, 2, 0, 2, 2);
        level2.add(card10);
        Card card11 = new Card(2,4, "white", 2, 2, 0, 2, 2);
        level2.add(card11);
        Card card12 = new Card(2,4, "red", 2, 2, 2, 2, 0);
        level2.add(card12);
        Card card13 = new Card(2,4, "green", 2, 2, 2, 0, 2);
        level2.add(card13);
        Card card14 = new Card(2,4, "blue", 2, 0, 2, 2, 2);
        level2.add(card14);
        Card card15 = new Card(2,4, "black", 0, 2, 2, 2, 2);
        level2.add(card15);
    }

    public void buildLevel3() { //building an arraylist to store level3 cards
        level3 = new ArrayList<Card>();
        Card card1 = new Card(3,3, "black", 2, 2, 1, 2, 0);
        level3.add(card1);
        Card card2 = new Card(3,3, "blue", 2, 0, 1, 2, 2);
        level3.add(card2);
        Card card3 = new Card(3,3, "green", 0, 2, 1, 2, 2);
        level3.add(card3);
        Card card4 = new Card(3,3, "red", 2, 2, 1, 0, 2);
        level3.add(card4);
        Card card5 = new Card(3,3, "white", 2, 2, 0, 1, 2);
        level3.add(card5);
        Card card6 = new Card(3,4, "black", 2, 2, 2, 2, 0);
        level3.add(card6);
        Card card7 = new Card(3,4, "blue", 2, 0, 2, 2, 2);
        level3.add(card7);
        Card card8 = new Card(3,4, "green", 0, 2, 2, 2, 2);
        level3.add(card8);
        Card card9 = new Card(3,4, "red", 2, 2, 2, 0, 2);
        level3.add(card9);
        Card card10 = new Card(3,4, "white", 2, 2, 0, 2, 2);
        level3.add(card10);
        Card card11 = new Card(3,5, "black", 2, 2, 2, 0, 3);
        level3.add(card11);
        Card card12 = new Card(3,5, "blue", 2, 2, 2, 2, 2);
        level3.add(card12);
        Card card13 = new Card(3,5, "green", 1, 2, 2, 2, 2);
        level3.add(card13);
        Card card14 = new Card(3,5, "red", 2, 2, 2, 1, 2);
        level3.add(card14);
        Card card15 = new Card(3,5, "white", 2, 2, 1, 2, 2);
        level3.add(card15);
    }
